...
6.	Once it is done loading, make sure the runCode function found in runCode.java runs without errors. It is found inside the project in the ``src/runCode/java/runCode.java`` directory. 
