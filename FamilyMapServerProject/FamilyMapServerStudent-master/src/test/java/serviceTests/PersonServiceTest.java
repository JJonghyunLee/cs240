...
public class PersonServiceTest {
    ...
    public void doServicePass() throws DataAccessException {
        ...
        PersonResult result = service.doService(newPerson.getPersonID(), username);
        assertEquals(newPerson.getPersonID(), result.getPersonID());
    ...
    public void doServiceFail() throws DataAccessException {
        ...
        assertNotNull(pDao.find(unassociatedPerson.getPersonID()));
        db.closeConnection(false);
        PersonResult result = service.doService(newPerson.getPersonID(), invalidUsername);
