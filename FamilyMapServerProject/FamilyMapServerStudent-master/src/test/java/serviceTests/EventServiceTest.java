...
public class EventServiceTest {
    ...
    public void doServicePass() throws DataAccessException {
        ...
        EventResult result = service.doService(birth.getEventID(), username);
        assertEquals(birth.getEventID(), result.getEventID());
    }
    ...
    public void doServiceFail() throws DataAccessException {
        ...
        assertNotNull(eDao.find(unassociatedEvent.getEventID()));
        db.closeConnection(false);
        EventResult result = service.doService(birth.getEventID(), invalidUsername);
